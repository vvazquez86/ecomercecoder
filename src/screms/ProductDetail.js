...
const productoEjemplo = productos[1];
        ...
        <SafeAreaView>
            ...
            <View style={styles.container}>
                <Image
                    ...
                    source={{
                        uri: productoEjemplo.images[2]
                    }}
                />
            </View>
            <View style={styles.containerDetalle}>
                <Text style={styles.titulo}>{productoEjemplo.title}</Text>
                <Text>{productoEjemplo.description}</Text>
                <Text style={styles.precio}>Precio: ${productoEjemplo.price}</Text>
            </View>
            ...
            <View style={styles.rating}>
                ...
                <Text style={styles.ratingItems}>Rating: {productoEjemplo.rating}</Text>
            </View>
        </SafeAreaView>
    )
}
